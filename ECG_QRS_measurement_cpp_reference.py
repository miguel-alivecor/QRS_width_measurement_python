...
def ECG_QRS_measurement(beat_avg, medianRR, Fs = 300):
    ...
    try:
        ...
        beat_avg_bpf = signal.filtfilt(b, a, beat_avg)
        ...
        aux = aux[::-1]
        peaks, peaks_properties = find_peaks(aux, prominence=pr_threshold, height=-0.5, distance=10)
        peaks2, peaks_properties2 = find_peaks(-aux, prominence=pr_threshold, height=-0.5, distance=10)
